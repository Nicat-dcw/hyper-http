...
async function main() {
  ...
  try {
    ...
    console.log(
      ...
      (
        hyperHttpResults.requests.average / honoResults.requests.average
      ).toFixed(2),
    );
    console.log(
      "Requests/sec ratio (Hono vs Express):",
      (honoResults.requests.average / expressResults.requests.average).toFixed(
        2,
      ),
    );
    console.log(
      "Latency ratio (HyperHttp vs Hono):",
      (hyperHttpResults.latency.average / honoResults.latency.average).toFixed(
        2,
      ),
    );
    console.log(
    ...
    console.log(
      ...
      (
        hyperHttpResults.throughput.average / honoResults.throughput.average
      ).toFixed(2),
    );
    console.log(
      "Throughput ratio (Hono vs Express):",
      (
        honoResults.throughput.average / expressResults.throughput.average
      ).toFixed(2),
    );
  } catch (error) {
